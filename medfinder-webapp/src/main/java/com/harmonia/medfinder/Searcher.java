...
public class Searcher {
	 ...
	 */
	public Response getAdverseDrugEvents(String ageStart, String ageEnd,
			String dateStart, String dateEnd, String weightStart,
			String weightEnd, String gender, String indication,
			String brandName, String genericName, String manufacturerName,
			String substanceName, Integer limit) throws EncodingException {
	 ...
	 */
	public Response getRoutes(String indication, String brandName,
			String genericName, String manufacturerName, String substanceName,
			Integer limit) throws EncodingException {
	 ...
	 */
	public Response getDrugs(String indication, String route, Integer limit)
	 ...
	 */
	public Response createSavedSearch(String name, Search.SearchType type,
			String indication, String brandName, String genericName,
			String manufacturerName, String substanceName, Integer minAge,
			Integer maxAge, Double minWeight, Double maxWeight, String gender,
			String route, SearchBean searchBean) {
	...
	private String createDrugsParameter(String indication, String brandName,
		...
		if (StringUtils.isNotBlank(indication)) {
			sb.append("patient.drug.drugindication:"
					+ encoder.encodeForURL(indication.toUpperCase()));
			sb.append(or);
		}
		if (StringUtils.isNotBlank(brandName)) {
	...
	private String createDrugRouteSearch(String indication, String route)
		...
		if (StringUtils.isNotBlank(indication) && StringUtils.isNotBlank(route)) {
			search = "indications_and_usage:"
					+ encoder.encodeForURL(indication) + "+AND+openfda.route:"
					+ route.toUpperCase();
		}
